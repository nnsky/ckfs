...
<body>
    ...
    <div class='gatas'></div>
    <center>
        <ul style="position: absolute;top: 10%;width: 85%;" class="text-center">
    ...
    <center><img src='fsjan/basic/index2.png' class='img-fluid'></center>
    ...
    <div class="col-sm-12">
        ...
        <div class="row">
            ...
            if ($hari >= 211208) {
                echo '
        <div class="col-lg-6">
	<a href="d1"><img src="fsdesc/tombol/ss1.png" class="img-fluid " style="margin-bottom: 5px;"></a>
	</div>
	';
            } else {
            }
        ...
        <div class="col-lg-6">
	<a href="d2"><img src="fsdesc/tombol/ss2.png" class="img-fluid " style="margin-bottom: 5px;"></a>
	</div>
	';
            } else {
            }
        ...
        <div class="col-lg-6">
	<a href="d3"><img src="fsdesc/tombol/ss3.png" class="img-fluid " style="margin-bottom: 5px;"></a>
	</div>
	';
            } else {
            }
            ...
            if ($hari >= 211229) {
                echo '
        <div class="col-lg-6">
	<a href="d4"><img src="fsdesc/tombol/ss4.png" class="img-fluid " style="margin-bottom: 5px;"></a>
	</div>
	';
            } else {
            }
        ...
        <div class="col-lg-6">
	<a href="d5"><img src="fsdesc/tombol/ss5.png" class="img-fluid " style="margin-bottom: 5px;"></a>
    </div>
	';
            } else {
            }
